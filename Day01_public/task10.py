...
if __name__ == "__main__":
    ...
    cv2.imwrite("../data/hist_eqlzn/02_img_orig.png", img_gray)
    cv2.imwrite("../data/hist_eqlzn/02_img_stretched.png", img_gray_stretched)

    plt.hist(img_gray)
    # plt.show()
    plt.savefig("../data/hist_eqlzn/02_hist_orig.png")

    plt.hist(img_gray_stretched)
    # plt.show()
    plt.savefig("../data/hist_eqlzn/02_hist_stretched.png")
